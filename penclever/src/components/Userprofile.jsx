    ...
    <div className="body">
      ...
      <div className="app">
        <div className="header123">
          ...
          <div className="header123-profile">
        ...
        <div className="wrapper">
          ...
          <div className="main-container">
            <div className="content-wrapper">
              <div className="content-wrapper-header123">
              ...
              <div className="content-section">
                ...
                <br />
                <br />
                <div className="profilename">Aditya Ray</div>
                <div className="profilestats">452 followers | 30 following</div>

                <div className="content-section-title">Recent activity</div>
                <ul>
                  <li className="recent-activity">
                    <div className="products">
                      Aditya Ray liked "How to make a css carousel?"
                    </div>

                    <div
                      className="button-wrapper"
                      style={{ color: "rgb(250,250,250,0.5)" }}
                    >
                      2 days ago
                    </div>
                  </li>
                  <li className="recent-activity">
                    <div className="products">
                      Aditya Ray started following "Ankit"
                    </div>
                  ...
                  <li className="recent-activity">
                    <div className="products">
                      Aditya Ray started following "Tenhuri"
                    </div>
